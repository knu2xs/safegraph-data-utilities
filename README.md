# safegraph-data-utilities

A few utilities I created for working with Safegraph data for downloading directly from Amazon S3.
...
```
    ...
    ├── setup.py           <- Setup script for the library (sg_data)
    ...
    │   ├── safegraph-data-utilities.aprx <- ArcGIS Pro project.    
    │   └── safegraph-data-utilities.tbx  <- ArcGIS Pro toolbox associated with the project.
    ...
    └── src                <- Source code for use in this project.
        └── sg_data <- Library containing the bulk of code used in this 
                                                  project. 
```
